...
export default function PostappContentContainer() {
  ...
  const sureDelete = () => {
    ...
    defaultRenderData.deletePost(deleteId)
  }
  ...
  const sureEdit = async (e) => {
    e.preventDefault()
    defaultRenderData.updatePost({ editId, title: newValueTitle.current.value, imgUrl: newValueImgUrl.current.value })
    setEditModal(false)
  }
